...
<?php else :
	...
	*/
	...
	?><a href="#content-popup-<?php echo $bID?>" class=" btn btn-primary btn-plain<?php // echo $o->popup_button_type . ' ' . $o->popup_button_color ?> mpf-inline open-popup-link"><?php echo $heading_value ?></a>
