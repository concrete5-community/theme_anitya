...
$styleObject = $pageTheme->getClassSettingsObject($b,$o->image_slider_slidesToShow,$o->image_slider_margin);
...
$options->autoplaySpeed = (int)$o->image_slider_autoplaySpeed;
 ...
 ?>
<div class="an-image-slider slick-wrapper" data-slick='<?php echo json_encode($options) ?>' id="slick-wrapper-<?php echo $bID?>">
