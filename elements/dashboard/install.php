...
$spPath = 'packages/theme_anitya/starting_points';
					...
					<div class="info">
						<div class="inner">
							...
							<div class="btn-group" role="group">
							 ...
							 <a href="http://<?php echo $spHandle?>.anitya.myconcretelab.com/" target="_blank" class="btn btn-default"><?php echo t('Live Preview') ?></a>
							</div>
						</div>
					</div>
				</div>
