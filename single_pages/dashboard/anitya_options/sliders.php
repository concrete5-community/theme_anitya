...
$options = array(
    array(
        ...
        'desc' => t("Anitya offer multiple custom template for the built-in page-list block that display pages into a carousel. Below you will fint options to take the controls of different settings"),
        "icon" => 'fa-ellipsis-h',
        'type' => 'section'
    ),
    array(
    ...
    array(
        ...
        array(
            ...
            'desc' => t("Anitya offer a custom template for Satck displayer that display blocks into a carousel or slider. Below you will fint options to take the controls of different settings of this Carousel"),
            "icon" => 'fa-ellipsis-h',
            'type' => 'section'
        ),
        array(
    ...
    array(
        'name' => t("Image Slider"),
        'desc' => t("Options when 'Anitya Slider' is choosed as custom template for the Image Slider block"),
        "icon" => 'fa-picture-o',
        'type' => 'section'
    ),
    array(
